...
# Read the TSV file
data = pd.read_csv("diamond/pocp-combined.tsv", sep="\t", index_col=0)
#data = pd.read_csv("blastp/pocp-combined.tsv", sep="\t", index_col=0)
...
heatmap.get_figure().savefig("diamond/pocp-heatmap.svg", format="svg", bbox_inches="tight")
#heatmap.get_figure().savefig("blastp/pocp-heatmap.svg", format="svg", bbox_inches="tight")
